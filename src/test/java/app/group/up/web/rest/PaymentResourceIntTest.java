...
import app.group.up.repository.PaymentRepository;
import app.group.up.service.PaymentService;
import app.group.up.repository.search.PaymentSearchRepository;
import app.group.up.service.dto.PaymentDTO;
import app.group.up.service.mapper.PaymentMapper;
...
public class PaymentResourceIntTest {
    ...
    private static final Integer DEFAULT_PAYMENT_NO = 1;
    private static final Integer UPDATED_PAYMENT_NO = 2;
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.getPaymentNo()).isEqualTo(DEFAULT_PAYMENT_NO);
        assertThat(testPayment.getDueDate()).isEqualTo(DEFAULT_DUE_DATE);
    ...
    @Test
    @Transactional
    public void checkPaymentNoIsRequired() throws Exception {
    ...
    public void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].paymentNo").value(hasItem(DEFAULT_PAYMENT_NO)))
    ...
    public void getPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments/{id}", payment.getId()))
            ...
            .andExpect(jsonPath("$.paymentNo").value(DEFAULT_PAYMENT_NO))
    ...
    public void updatePayment() throws Exception {
        ...
        Payment testPayment = paymentList.get(paymentList.size() - 1);
        assertThat(testPayment.getPaymentNo()).isEqualTo(UPDATED_PAYMENT_NO);
        assertThat(testPayment.getDueDate()).isEqualTo(UPDATED_DUE_DATE);
