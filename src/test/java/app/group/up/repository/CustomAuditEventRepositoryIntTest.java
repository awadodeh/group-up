...
import app.group.up.config.audit.AuditEventConverter;
import app.group.up.domain.PersistentAuditEvent;
...
import static app.group.up.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
