...
@Component({
    selector: 'jhi-review-my-suffix',
    templateUrl: './review-my-suffix.component.html'
})
export class ReviewMySuffixComponent implements OnInit, OnDestroy {
reviews: ReviewMySuffix[];
    currentAccount: any;
    ...
    trackId(index: number, item: ReviewMySuffix) {
        return item.id;
    }
